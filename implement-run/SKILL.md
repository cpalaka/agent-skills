---
name: implement-run
description: How one ticket is run under an implementation run — the seats, the advisor's three slots, the gates, the review and the closing run record. Slash-only (/implement-run), beside the third-party /implement stub.
