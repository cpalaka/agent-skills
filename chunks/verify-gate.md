...
in `<!-- knobs:verify-gate -->`, in the contract your host adapter names, and must pass when due;
`none — <why>` declares it absent. **build** is a production build, `build_check`
its output assertion; a green build is not a working app,
